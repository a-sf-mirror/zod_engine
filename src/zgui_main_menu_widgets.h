...
enum mmwidget_type
{
	...
	MMLIST_WIDGET, MMRADIO_WIDGET, MMTEAM_COLOR_WIDGET,
	MMTEXT_BOX_WIDGET, 
	MAX_MMWIDGETS
};
...
#define MMTEXT_BOX_HEIGHT 14


class GMMWTextBox : public ZGMMWidget
{
public:
	GMMWTextBox();
	...
	void SetPassworded(bool passworded_) { passworded=passworded_; do_rerender = true; }
private:
	static bool finished_init;

	static ZSDL_Surface top_img;
	static ZSDL_Surface left_img;
	static ZSDL_Surface right_img;
	static ZSDL_Surface bottom_img;
